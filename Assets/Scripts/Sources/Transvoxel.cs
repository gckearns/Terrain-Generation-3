...
public struct RegularCellData
{
    ...
    byte _geometryCounts;
    /// <summary> Groups of 3 indexes giving the triangulation. </summary>
    byte[] _vertexIndex;  //[15]

    public RegularCellData(byte geometryCounts, byte[] vertexIndex)
    {
        _geometryCounts = geometryCounts;
        _vertexIndex = vertexIndex;
    }

    public long VertexCount { get => _geometryCounts >> 4; }

    public long TriangleCount { get => _geometryCounts & 0x0F; }

    public byte[] VertexIndices { get => _vertexIndex; }
};
...
{
    /// <summary> High nibble is vertex count, low nibble is triangle count. </summary>
    long _geometryCounts;
    /// <summary> Groups of 3 indexes giving the triangulation. </summary>
    byte[] _vertexIndex;  //[36]
...
public class Transvoxel
{
    ...
    /// </summary>
    public static readonly ushort[][] regularVertexData = new ushort[256][] //[256][12]
    {
        new ushort[]{},
    ...
    /// </summary>
    public static readonly ushort[][] transitionVertexData = new ushort[512][] //[512][12]
    {
	    new ushort[]{},
